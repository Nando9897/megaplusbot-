...
### Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Nando9897/megaplusbot-)
...
- Clone the Repo
```
git clone https://github.com/Nando9897/megaplusbot-
```
- Enter the directory
```
cd MegaDL-Bot
